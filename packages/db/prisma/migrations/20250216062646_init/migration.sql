...
-- CreateEnum
CREATE TYPE "EthnecityEnum" AS ENUM ('Black', 'White', 'AsianAmerican', 'EastAsian', 'SouthEastAsian', 'SouthAsian', 'MiddleEastern', 'Pacific', 'Hispanic', 'Other');
...
CREATE TABLE "Model" (
    ...
    "etnecity" "EthnecityEnum" NOT NULL,
